-- TGT COUNTRY
create or replace TABLE TGT.DWH_D_COUNTRY_LU (
...
-- TGT REGION
create or replace TABLE TGT.DWH_D_REGION_LU (
	ID NUMBER(38,0) NOT NULL,
...
-- TGT STORE
create or replace TABLE TGT.DWH_D_STORE_LU (
	ID NUMBER(38,0) NOT NULL,
...
-- TGT CUSTOMER
create or replace TABLE TGT.DWH_D_CUSTOMER_LU (
	ID NUMBER(38,0) NOT NULL,
...
-- TGT TRANSACTION
create or replace TABLE TGT.DWH_D_CATEGORY_LU (
	ID NUMBER(38,0) NOT NULL,
...
-- TGT TRANSACTION
create or replace TABLE TGT.DWH_D_SUBCATEGORY_LU (
	ID NUMBER(38,0) NOT NULL,
...
-- TGT PRODUCT
create or replace TABLE TGT.DWH_D_PRODUCT_LU (
	ID NUMBER(38,0) NOT NULL,
